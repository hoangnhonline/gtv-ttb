...
<section class="content">
  ...
  <form role="form" method="POST" action="{{ route('booking-payment.store') }}" id="dataForm">
    <div class="row">
       <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->               
              ...
              <div class="box-footer">
                ...
                <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('booking-payment.index', ['booking_id' => $booking_id])}}">Hủy</a>
              </div>
