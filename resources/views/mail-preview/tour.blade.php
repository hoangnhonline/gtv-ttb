                ...
                <tr>
                    <td colspan="2" style="color: red;">
                        <p style="text-align: right;">
                            <a href="{{ route('book-tour-cau-muc', ['id' => $detail->id])}}" class="btn btn-sm btn-success" style="padding: 5px 10px; background-color: red; text-decoration: none; color: white;">Gửi mail John</a>
                        </p>
                    </td>
                </tr>
                @endif
                        ...
                        <div>
                            <div dir="ltr">
                                <div dir="ltr">
                                    ...
                                    <span style="color: rgb(0, 0, 0); font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px;"><b>Địa chỉ:</b> 124 Trần Hưng Đạo, Dương Đông, Phú Quốc</span>
