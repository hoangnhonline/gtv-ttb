...
<section class="content-header" style="padding-top: 10px;">
  <h1 style="text-transform: uppercase;">    
    ...
    @elseif($time_type == 1)
    BOOKING THÁNG {{$month}}/{{ $year }}
    @elseif($time_type == 2)
    BOOKING TỪ {{ date('d/m', strtotime($use_date_from_format)) }} ĐẾN {{ date('d/m', strtotime($use_date_to_format)) }}
    @endif
  </h1>
    ...
    <div class="col-md-12">
      ...
      <div style="background-color: #dbdbd5;" class="table-responsive">
       ...
       <table class="table table-bordered" id="table_report">
              ...
              <tr>
                  <td>Dù đôi : {{ $arrData['tong_du_doi'] }} cây</td>
                  <?php 
                ...
                <tr>
                  <td>Dù đơn : {{ $arrData['tong_du_don'] }} cây</td>
                  <?php 
       ...
       <table class="table table-bordered" id="table_report">
              ...
              <tr>
                <th>Tổng KO flycam</th>
                <td class="text-right">
                  {{ number_format($arrData['tong_tien_ko_cam_jt']) }}
                </td>
              </tr>
              <tr>
                <th>Tổng đã chi cano + HDV</th>
                <td class="text-right">
                  {{ number_format($arrData['tong_chietkhau']) }}
                </td>
              </tr>
                ...
                <span class="label label-sm label-danger" id="error_unc_{{ $item->id }}"></span>       
                 ...
                 <table class="table" style="margin-top:5px;margin-bottom: 10px;">
                  ...
                  - Tổng tiền: {{ number_format($item->total_price) }} 
                    ...
                    <br>- Chiết khấu: <span style="color: blue;font-weight: bold;">{{ number_format(($item->total_price - $item->discount)*0.1) }}<br>
                    @if($item->notes)                    
                    <span style="color:red; font-style: italic;">{!! nl2br($item->notes) !!}</span>
                    @endif    
