        ...
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="{{ route('booking-hotel-dn.index') }}" id="searchForm">
            ...
            <div class="form-group col-xs-4" style="padding-right: 3px">                            
              <input type="text" class="form-control datepicker" autocomplete="off" name="book_date" value="{{ $arrSearch['book_date'] }}"  placeholder="Ngày đặt từ">
            </div>
            <div class="form-group  col-xs-4" style="padding-right: 3px">                            
            ...
            <ul style="padding: 10px">
              ...
              <li id="row-{{ $item->id }}" style="border-bottom: 1px solid #CCC;padding-top: 10px;padding-bottom: 10px">
                ...
                <p>
                  ...
                  <a style="font-size:17px" href="{{ route( 'booking-hotel-dn.edit', $arrEdit) }}">{{ $item->name }} / {{ $item->phone }}</a>
                  {{ $item->email }}
                </p> 
                <p>
                  @if($item->hotel)
