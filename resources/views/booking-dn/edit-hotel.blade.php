...
<div class="content-wrapper">
  ...
  <h1 style="text-transform: uppercase;">  
      Đặt khách sạn Đà Nẵng : cập nhật <span style="color: red">PTH{{ $detail->id }}</span>
    </h1>    
  </section>
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-hotel-dn.update-hotels') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
          ...
          @endif
            ...
            <hr>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4" style="padding-right: 0px">
                      ...
                      <select class="form-control" name="nguoi_thu_coc" id="nguoi_thu_coc">
                        ...
                        <option value="2" {{ old('nguoi_thu_coc', $detail->nguoi_thu_coc) == 2 ? "selected" : "" }}>KS thu cọc</option>
                      </select>
                  </div>
                  @php
                    if($detail->ngay_coc){
                ...
                <div class="row">
                  ...
                  @endphp 
                  <div class="form-group @if(Auth::user()->role == 1) col-xs-7 @else col-xs-12  @endif" >
