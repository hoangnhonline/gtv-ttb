...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-car-dn.store-car') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
                ...
                <div class="form-group col-md-4">                    
                  ...
                  <select class="form-control select2" id="tour_id" name="tour_id">     
                    <option value="">--Chọn--</option>                
                      ...
                      <option value="{{ $cate->id }}" {{ old('tour_id') == $cate->id  ? "selected" : "" }}>{{ $cate->name }}</option>
                      @endforeach
                  </select>
                </div>  
                <div class="form-group col-md-4" >                    
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4">
                      ...
                      <select class="form-control" name="nguoi_thu_tien" id="nguoi_thu_tien">
                        ...
                        <option value="3" {{ old('nguoi_thu_tien') == 3 ? "selected" : "" }}>Tài xế</option>
                      </select>
                  </div>
                </div>
                <div class="row">
