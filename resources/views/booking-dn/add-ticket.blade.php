...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('booking-ticket-dn.index' ) }}" style="margin-bottom:5px">Quay lại</a>
    <a class="btn btn-success btn-sm" href="{{ route('booking-ticket-dn.index') }}" style="margin-bottom:5px">Xem danh sách booking</a>
    <form role="form" method="POST" action="{{ route('booking-ticket-dn.store-ticket') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <input type="hidden" name="type" value="3">
                ...
                <div class="row">
                  <div class="form-group col-xs-6 col-md-4">
                      ...
                      <select class="form-control select2 ticket_type" name="ticket_type_id[]" id="ticket_type_id{{ $k }}">  
                        ...
                        @foreach($cateList as $ticket)
                        <option data-price="{{ number_format($ticket->price) }}" value="{{ $ticket->id }}" {{ old('ticket_type_id.'.$k) == $ticket->id  ? "selected" : "" }}>{{ $ticket->name }}</option>
                        @endforeach
                      </select>
                  </div>
                ...
                <div class="row">
                  ...
                  @endif 
                    <div class="form-group @if(Auth::user()->role == 1) col-xs-6 @else col-xs-12  @endif" >
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-defaulD btn-sm" class="btn btn-primary btn-sm" href="{{ route('booking-ticket-dn.index')}}">Hủy</a>
            </div>
