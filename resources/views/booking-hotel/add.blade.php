              ...
              <input type="hidden" name="type" value="2">
                ...
                <div class="row">
                  <div class="form-group col-xs-5" style="padding-right: 0px">
                    ...
                    <input type="text" class="form-control number" name="total_price_original" id="total_price_original" value="{{ old('total_price_original') }}">
                  </div>
                  <div class="form-group col-xs-5" style="padding-right: 0px">
...
<script type="text/javascript">  
  ...
  function setPrice(){
    var total_price = total_price_original = 0;
    $('.rooms-row').each(function(){
      ...
      if(room_amount > 0 && room_night > 0 && room_price > 0){
        ...
        total_price_original += room_price_total_original;
      }     
    ...
    total_price_original = total_price_original + extra_fee;  
    
    $('#total_price').val(total_price);
    $('#total_price_original').val(total_price_original);
