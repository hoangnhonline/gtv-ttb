                     ...
                     <div role="tabpanel" class="tab-pane" id="doitac">
                      ...
                      <div role="tabpanel" class="tab-pane" id="chinhsach">
                          <div class="row">
                              ...
                              <input type="text" class="form-control req" name="check_in" id="check_in" value="{{ old('check_in', $detail->check_in) }}">
                            </div>
                            <div class="col-md-6 form-group" >                  
                              <label>Giờ trả phòng</label>
                              <input type="text" class="form-control req" name="checkout" id="checkout" value="{{ old('checkout', $detail->checkout) }}">
                            </div>
                          </div>
                          <div class="form-group" >                  
                          ...
                          <div class="form-group" >                  
                            ...
                            <textarea class="form-control" name="policy" id="policy" rows="10">{{ old('policy', $detail->policy) }}</textarea>
                          </div>
                          <div class="form-group" >                  
                            <label>Chính sách phụ thu</label>
                            <textarea class="form-control" name="surcharge" id="surcharge" rows="10">{{ old('surcharge', $detail->surcharge) }}</textarea>
                          </div>
                      </div>
