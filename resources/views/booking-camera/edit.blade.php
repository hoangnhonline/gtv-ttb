...
<div class="content-wrapper">
  ...
  <h1 style="text-transform: uppercase;">  
      Đặt lịch chụp ảnh : cập nhật <span style="color: red">PTC{{ $detail->id }}</span>
    </h1>    
  </section>
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('booking-camera.update') }}" id="dataForm">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">                    
                  ...
                  <select class="form-control select2" id="camera_id" name="camera_id">     
                    <option value="">--Chọn--</option>                
                      ...
                      <option value="{{ $cate->id }}" {{ old('camera_id', $detail->camera_id) == $cate->id  ? "selected" : "" }}>{{ $cate->name }}</option>
                      @endforeach
                  </select>
                </div>  
                @php
                ...
                <div class="row">
                <div class="form-group col-md-6">
                      <label>Hoa hồng thợ chụp</label>
                      <input type="text" name="hoa_hong_chup" id="hoa_hong_chup" class="form-control number" value="{{ old('hoa_hong_chup', $detail->hoa_hong_chup) }}">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4">
                      ...
                      <select class="form-control" name="nguoi_thu_tien" id="nguoi_thu_tien">
                        ...
                        <option value="3" {{ old('nguoi_thu_tien', $detail->nguoi_thu_tien) == 3 ? "selected" : "" }}>Thợ chụp</option>
                      </select>
                  </div>
                </div>
                <div class="row">
