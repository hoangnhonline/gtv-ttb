              ...
              <tr>
                ...
                <td class="text-left" style="vertical-align: middle;">
                  <ul style="padding-left: 10px">
                      <li style="list-style: none;"><span style="width: 80px;float:left;display: block;">CTY thu:</span> <span style="font-weight: bold;">{{ number_format($t_cty) }}</span></li>
                      <li style="list-style: none;"><span style="width: 80px;float:left;display: block;">TX thu:</span> <span style="font-weight: bold;">{{ number_format($t_tx) }}</span></li>
                      <li style="list-style: none;"><span style="width: 80px;float:left;display: block;">Sales thu:</span> <span style="font-weight: bold;">{{ number_format($t_sales) }}</span></li>
                  </ul>
                </td>                    
              </tr>
          </table>
          ...
          <ul style="padding: 5px">
              ...
              @foreach( $driverArrName as $driverId => $driverName )
                ...
                @if(isset($arrDriver[$driverId]))
                 ...
                 ?>
                <li style="border-bottom: 1px solid #ddd; padding-bottom: 10px; padding: 10px; font-size:17px;list-style: none;"> 
                    <a style="font-size:17px; text-transform: uppercase;" href="">{{ $i }}. {{ $driverName }}</a>                  
                    <br>
                    <ul style="padding-left: 15px">
                      <li style="list-style: none;"><span style="width: 100px;float:left;display: block;">Số chuyến:</span> <span style="font-weight: bold;">{{ number_format($arrDetail['so_lan_chay']) }}</span></li>
                      <li style="list-style: none;"><span style="width: 100px;float:left;display: block;">Tổng tiền:</span> <span style="font-weight: bold;">{{ number_format($arrDetail['tong_tien']) }}</span></li>
                      <li style="list-style: none;"><span style="width: 100px;float:left;display: block;">CTY thu:</span> <span style="font-weight: bold;">{{ number_format($arrDetail['so_tien_tx_thu']) }}</span></li>
                      <li style="list-style: none;"><span style="width: 100px;float:left;display: block;">TX thu:</span> <span style="font-weight: bold;">{{ number_format($arrDetail['so_tien_cty_thu']) }}</span></li>
                      <li style="list-style: none;"><span style="width: 100px;float:left;display: block;">Sales thu:</span> <span style="font-weight: bold;">{{ number_format($arrDetail['so_tien_sales_thu']) }}</span></li>
                    </ul>
                </li>
                @endif
              @endforeach
