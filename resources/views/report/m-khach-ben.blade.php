    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">        
        <div class="panel-body">
          <form role="form" method="GET" action="{{ route('report.ben') }}" id="searchForm">
            <div class="row">
                ...
                <div class="form-group col-xs-6">
                  ...
                  <option value="7" {{ $arrSearch['tour_id'] == 7 ? "selected" : "" }}>Bãi Sao-Địa Trung Hải</option>
            ...
            <div class="row">
             ...
             <div class="form-group {{ $time_type == 3 ? "col-xs-6" : "col-xs-12" }}">              
            ...
            @if($time_type == 1)
            <div class="form-group  chon-thang {{ $time_type == 1 ? "col-xs-6" : "" }}">                
            ...
            <div class="form-group chon-ngay {{ $time_type != 1 ? "col-xs-6" : "" }}">              
            ...
            @if($time_type == 2)
            <div class="form-group chon-ngay den-ngay {{ $time_type != 1 ? "col-xs-6" : "" }}">              
        ...
        <!-- /.box-header -->
         <div class="box-body">
          ...
          <div class="table-responsive">
            ...
            Số NL: <span style="color: red">{{ number_format($tong_so_nguoi )}} </span></span> 
            </div>
