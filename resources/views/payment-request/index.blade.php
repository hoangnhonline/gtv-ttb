        ...
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="{{ route('payment-request.index') }}" id="searchForm">
            ...
            <div class="form-group chon-ngay">              
              <input type="text" class="form-control datepicker" autocomplete="off" name="use_date_from" placeholder="Từ ngày" value="{{ $arrSearch['use_date_from'] }}" style="width: 110px">
            </div>
            ...
            @endif
            <div class="form-group">
              <input type="checkbox" name="urgent" id="urgent" {{ $arrSearch['urgent'] == 1 ? "checked" : "" }} value="1">
            ...
            @if( $items->count() > 0 )
              ...
              <tr class="cost" id="row-{{ $item->id }}">                
                ...
                <td style="white-space:nowrap">                  
                  @if($item->status == 1 || Auth::user()->role == 1)
