...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">      
      ...
      @endif
      <a href="{{ route('booking-car.create') }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      <a href="{{ route('drivers.create') }}?back_url={{ urlencode(Request::fullUrl()) }}" class="btn btn-primary btn-sm" style="margin-bottom:5px">Thêm tài xế</a>
        ...
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="{{ route('booking-car.index') }}" id="searchForm">
            ...
            <div class="form-group chon-ngay">              
              <input type="text" class="form-control datepicker" autocomplete="off" name="use_date_from" placeholder="@if($time_type == 2) Từ ngày @else Ngày @endif " value="{{ isset($arrSearch['use_date_from']) ? $arrSearch['use_date_from'] : "" }}" style="width: 120px">
            </div>
           
            @if($time_type == 2)
            <div class="form-group chon-ngay den-ngay">              
              <input type="text" class="form-control datepicker" autocomplete="off" name="use_date_to" placeholder="Đến ngày" value="{{ isset($arrSearch['use_date_to']) ? $arrSearch['use_date_to'] : "" }}" style="width: 120px">
            </div>
             @endif
            @endif            
            @if(Auth::user()->role == 1)
            ...
            <div class="form-group">
              <select class="form-control select2" name="nguoi_thu_coc" id="nguoi_thu_coc">
                ...
                <option value="3" {{ $arrSearch['nguoi_thu_coc'] == 3 ? "selected" : "" }}>Tài xế</option>
            ...
            <div class="form-group">
              <select class="form-control select2" name="nguoi_thu_tien" id="nguoi_thu_tien">
                ...
                <option value="3" {{ $arrSearch['nguoi_thu_tien'] == 3 ? "selected" : "" }}>Tài xế</option>
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered" id="table-list-data">
            <tr>
              ...
              <th class="text-center" width="250">Tài xế</th>              
              ...
              <tr id="row-{{ $item->id }}" @if($item->driver_id == 0) style="background-color:#dee0e3" @endif>
                ...
                <td class="text-right">
                  ...
                  @if($item->nguoi_thu_tien == 1)
                    ...
                    <span style="color: red">Tài xế</span>
