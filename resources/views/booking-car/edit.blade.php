                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4" >
                      ...
                      <select class="form-control" name="nguoi_thu_coc" id="nguoi_thu_coc">
                        ...
                        <option value="3" {{ old('nguoi_thu_coc', $detail->nguoi_thu_coc) == 3 ? "selected" : "" }}>Tài xế</option>
                        <option value="4" {{ old('nguoi_thu_coc', $detail->nguoi_thu_coc) == 4 ? "selected" : "" }}>Điều hành</option>
                      </select>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-4">
                      ...
                      <select class="form-control" name="nguoi_thu_tien" id="nguoi_thu_tien">
                        ...
                        <option value="4" {{ old('nguoi_thu_tien', $detail->nguoi_thu_tien) == 4 ? "selected" : "" }}>Điều hành</option>
                      </select>
                  </div>
                </div>
                <div class="row">
